...
async function backfillSqlite(opts: Options, modelId: string): Promise<Summary> {
  ...
  const s: Summary = { rowsRead: 0, embedded: 0, skipped: 0, errors: 0, durationMs: 0 };
...
async function backfillMongo(opts: Options, modelId: string): Promise<Summary> {
...
function printSummary(s: Summary, opts: Options): void {
