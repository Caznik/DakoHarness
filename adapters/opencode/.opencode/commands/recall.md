...
Search long-term memory for context relevant to the keywords the user provided, using agent-side query expansion so paraphrased queries still find the right memories. Behavior is governed by the **Memory Query Expansion** protocol in `AGENTS.md`.
